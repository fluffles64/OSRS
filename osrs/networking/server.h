		...
		public:
			...
			bool Start()
			{
				try
				{
					...
					// connect. The order of these to lines in this context
					// is relevant because if we launch the context before giving
			...
			{
				// We wait until the client sends a message so that the server doesnt use 100% of the CPU core
